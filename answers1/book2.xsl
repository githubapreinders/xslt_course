...
<xsl:template match="para[1]">
  <table border="1"><tr><td><xsl:apply-templates/></td></tr></table>
</xsl:template>
...
<xsl:template match="ulist/ulist/li[1] | olist/olist/li[1] |
                     ulist/olist/li[1] | olist/ulist/li[1]">
  <li><table border="1"><tr><td><xsl:apply-templates/></td></tr></table></li>
</xsl:template>
