...
<!--129--><!ENTITY q8  "ancestor::that[1]">

                       <!--the most remote ancestor named 'that'-->
<!--130--><!ENTITY q9  "ancestor::that[position()=last()]">

                       <!--the immediately preceding sibling
                       element-->
<!--131--><!ENTITY q10 "preceding-sibling::*[1]">
...
<!--132--><!ENTITY q11 "following-sibling::*[1]">
                       ...
                       named 'that'-->
<!--133--><!ENTITY q12 "preceding-sibling::that[1]">
...
<!--135--><!ENTITY q14 "../*[7]">
<!--135--><!ENTITY q14 "(preceding-sibling::* | self::* |
                         following-sibling::*)[7]">
...
<!--137--><!ENTITY q16 "ancestor::that[@val='x'][2]">

                       <!--the closest ancestor with a element child
                       named 'this' where that child has a 'val'
                       attribute of 'z'-->
<!--138--><!ENTITY q17 "ancestor::*[this/@val='z'][1]">
<!--138--><!ENTITY q17 "ancestor::*[this[@val='z']][1]">

                       <!--the last following sibling element named
                       'this'-->
<!--139--><!ENTITY q18 "following-sibling::this[position()=last()]">

                       <!--the first and last element child with a
                       'val' attribute of 'y'-->
<!--140--><!ENTITY q19 "*[@val='y'][position()=1 or position()=last()]">

                       <!--all elements in the document with a 'val'
                       attribute of 'x'-->
<!--141--><!ENTITY q20 "//*[@val='x']">

                       <!--all comments in the document (not an
                       attribute value)-->
<!--142--><!ENTITY q21 "//comment()">

                       <!--the element in which the 'cursor' processing
                       instruction is found-->
<!--143--><!ENTITY q22 "//*[processing-instruction('cursor')]">
<!--143--><!ENTITY q22 "/*//processing-instruction('cursor')/parent::*">
